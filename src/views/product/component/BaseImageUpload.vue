...
<template>
    <div class="upload-container">
        <a-upload list-type="picture-card" v-model:file-list="fileList" :custom-request="customRequest"
            :on-remove="onRemove" @change="handleChange" @preview="handlePreview" :max-count="maxCount"
            :accept="props.accept" :disabled="uploading">
            <div>
                <PlusOutlined />
