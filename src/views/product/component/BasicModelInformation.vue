...
<template>
    <a-form :model="formData" :label-col="{ style: { width: '100px' } }" :wrapper-col="{ span: 20 }"
        layout="horizontal" :rules="rules" ref="formRef" v-bind="$attrs">
        ...
        <a-form-item label="型号描述" name="description">
            <a-textarea v-model:value="formData.description" placeholder="请输入型号描述"
